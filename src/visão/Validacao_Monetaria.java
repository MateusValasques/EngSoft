 ...
 */
public class Validacao_Monetaria extends JTextField {
    ...
    public Validacao_Monetaria(int casasDecimais) {
        this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
    }
 
    public Validacao_Monetaria() {
        this(MONETARY_FORMAT);
    }
 
    public Validacao_Monetaria(NumberFormat format) {// define o formato do
        // número
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(Validacao_Monetaria.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
    ...
    public static void main(String[] args) {
        ...
        frame.add(new Validacao_Monetaria(new DecimalFormat("R$ 0.00")) {
            {// limita a 4
                // caracteres
                setLimit(100);
            }
